...
<PackageManagerTabs command={{
  npm: 'npx skills add github:Muromi-Rikka/scml-website/skills/scml-mod-development',
  yarn: 'yarn dlx skills add github:Muromi-Rikka/scml-website/skills/scml-mod-development',
  pnpm: 'pnpm dlx skills add github:Muromi-Rikka/scml-website/skills/scml-mod-development',
  bun: 'bunx skills add github:Muromi-Rikka/scml-website/skills/scml-mod-development',
  deno: 'deno run -A npm:skills add github:Muromi-Rikka/scml-website/skills/scml-mod-development',
}} />

Maplebirch Framework Skill:

<PackageManagerTabs command={{
  npm: 'npx skills add github:Muromi-Rikka/scml-website/skills/maplebirch-framework',
  yarn: 'yarn dlx skills add github:Muromi-Rikka/scml-website/skills/maplebirch-framework',
  pnpm: 'pnpm dlx skills add github:Muromi-Rikka/scml-website/skills/maplebirch-framework',
  bun: 'bunx skills add github:Muromi-Rikka/scml-website/skills/maplebirch-framework',
  deno: 'deno run -A npm:skills add github:Muromi-Rikka/scml-website/skills/maplebirch-framework',
}} />
